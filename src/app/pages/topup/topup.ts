...
export class TopupComponent implements OnInit {
  ...
  get canSubmit(): boolean {
    return !!this.amount && this.amountNum >= 1 && this.amountNum <= 50000 && !this.loading;
  }
  ...
  onSubmit(): void {
    ...
    this.walletSvc.topUp({ amount: this.amountNum, currency: 'INR', idempotencyKey: key }).subscribe({
      next: (res: any) => {
        this.loading = false;
